<div class="bg-white shadow-md items-center rounded-2xl w-full p-3 flex justify-between flex-col md:flex-row">
    ...
    <div id="mobile-menu" class="hidden flex justify-around items-center w-full mt-3 md:hidden">
        <a href="" class="hover:text-emerald-400 transition-all duration-300" title="Dashboard">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
            </svg>
        </a>
        <a href="" class="hover:text-emerald-400 transition-all duration-300" title="Notes">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
            </svg>
        </a>
        <a href="" class="hover:text-emerald-400 transition-all duration-300" title="Task">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="" class="hover:text-emerald-400 transition-all duration-300" title="Schedule">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
        </a>
        <a href="" class="hover:text-emerald-400 transition-all duration-300" title="Settings">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="hidden md:flex gap-2 text-sm">
        ...
        <a href="" class="hover:bg-emerald-400 hover:text-white rounded-md px-3 py-1.5 transition-all duration-300">Settings</a>
    </div>

    <!-- Conditional Content (Hidden when mobile menu is open) -->
    <div id="conditional-content" class="mt-2 md:mt-0 w-full md:w-auto">
        @if ($type == "name")
        <p class="text-sm text-center md:text-left">Kelas Bahasa Indonesia 8C</p>
        @elseif ($type == "search")
