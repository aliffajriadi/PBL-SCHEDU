        ...
        <table class="w-full text-sm text-left border-separate border-spacing-0">
            ...
            <tbody class="text-gray-600 divide-y">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 border-b">Class A</td>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 border-b">Class B</td>
                    <td class="py-3 px-4 border-b">John Doe</td>
                    <td class="py-3 px-4 border-b">22</td>
                    <td class="py-3 px-4 border-b">2025-02-10</td>
                    <td class="py-3 px-4 border-b flex gap-2">
