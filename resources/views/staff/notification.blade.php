    ...
    <script>
        ...
        function show_list(notifications)
        {
            ...
            datas.data.forEach((notification, index) => {
                ...
                is_read = notification.is_readed;
                parent.innerHTML += `
                    <a 
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-2">
                                        ...
                                        ${ !is_read ? '<span id="dot' + notification.id + '" class="w-2 h-2 bg-red-500 rounded-full"></span>' : '' }
                                    </div>
                                    <span class="text-xs font-semibold text-white bg-emerald-500 rounded-full px-2 py-1">${index+ 1}</span>
                                </div>
                                <p class="text-sm text-gray-600 mt-1 ${ is_read === 0 ? 'opacity-75' : '' }">${ notification.description }</p>
        ...
        {   
            ...
            get_data(`/staff/notifications?${query}&page=${current_page}`, show_list);
        }
